            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="orgName" class="col-md-4 col-form-label text-md-right">{{ __('Name of Organization') }}</label>

                            <div class="col-md-6">
                                <input id="orgName" type="text" class="form-control @error('orgName') is-invalid @enderror" name="orgName" value="{{ old('orgName') }}" required autocomplete="orgName" autofocus>
